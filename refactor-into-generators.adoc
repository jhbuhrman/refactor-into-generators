...
// FIXME: perhaps add somthing about TDD/Gherking
...
* There are many people advocating to put in-line parameters (like
  ...
  seen a string of some sort, but rather as a clearl indication that it
  is a parameter.
...
== Gherkin for the N'th Fibonacci number
[source,feature]
----
...
== Parametrized testcases using Gherkin's _Scenario Outlines_
[source,feature]
----
...
== Now the Product Owner really get enthusiastic!
--
[quote, Even More Excited Product Owner, Even More features]
____________________________________________________________________
Can you also make functions that return ...

* the first _n_ Fibonacci numbers,
* the largest Fibonacci number less than _n_, and
* the smallest Fibonacci number greater than or equal to _n_?
____________________________________________________________________
--


== Some more Gherkin specs to prevent ambiguity
