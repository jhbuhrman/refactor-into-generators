...
[.notes]
--
* But first, let me introduce myself: My name is Jan-Hein Bührman; you see my work email address and my twitter handle on the slide
...
* ✋ So who knows what a Fibonacci number is?
--
...
* Perhaps combine the requested functions ❓
...
* (It starts already with the ugly type annotation, and as the author of `Black`, Łukasz Langa, recently told us in a talk: "__ugly type annotations are an indication of ugly code__")
