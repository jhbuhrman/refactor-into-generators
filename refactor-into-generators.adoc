...
--
FIXME:
The League of Fibonacci lovers
-- or --
The Society of Fibonacci Lovers
-- or --
The Fibonacci fanclub
--
...
[source,python]
--
include::{sourcedir}/src/fibonacci/before.py[lines="29..34"]
--
...
[source,python]
--
include::{sourcedir}/src/fibonacci/refactored.py[lines="30..34"]
--
// {nbsp} +
[.text-left]
--
