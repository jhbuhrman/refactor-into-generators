...
In mathematics, the **Fibonacci numbers** {startsb}...{endsb} form a sequence, the **Fibonacci sequence**, in which each number is the sum of the two preceding ones. The sequence commonly starts from 0 and 1, {startsb}...{endsb}
...
{startsb}...{endsb} the next few values in the sequence are:
...
[source,python]
----
include::{sourcedir}/src/fibonacci/before.py[lines="11..20"]
----
