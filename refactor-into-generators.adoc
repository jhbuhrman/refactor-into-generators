...
== Topics
[role="incremental"]
* Loops with similar code but with different start/stop/selection criteria
* What is refactoring
...
(a fictional story)
[role="incremental"]
* Suppose your Product Owner requires a function that returns a list of all Fibonacci number less than _n_
...
* Now the Product Owner gets really excited and asks for more functionality:

// FIXME: perhaps change the word "excited" to something else?
[role="incremental"]
--
[quote, Excited Product Owner, More Features]
____________________________________________________________________
Can you also make a function that returns the _n_'th Fibonacci number (counting from zero)?
____________________________________________________________________
--
...
[source,python]
----
include::{sourcedir}/src/fibonacci/pre_refactor_compressed.py[lines="16..34"]
----
...
|===
a|[source,python]
include::{sourcedir}/src/fibonacci/pre_refactor_compressed.py[lines="2..8"]
a|[source,python]
include::{sourcedir}/src/fibonacci/pre_refactor_compressed.py[lines="16..22"]

a|[source,python]
include::{sourcedir}/src/fibonacci/pre_refactor_compressed.py[lines="10..14"]
a|[source,python]
include::{sourcedir}/src/fibonacci/pre_refactor_compressed.py[lines="24..28"]

|Do you see a pattern? ✋
a|[source,python]
include::{sourcedir}/src/fibonacci/pre_refactor_compressed.py[lines="30..34"]
|===
